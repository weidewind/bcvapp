...
class gsp_bcvapp_indextabs_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/index/tabs.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('captureMeta','sitemesh',15,['gsp_sm_xmlClosingForEmptyTag':("/"),'http-equiv':("Content-Type"),'content':("text/html; charset=iso-8859-1")],-1)
printHtmlPart(8)
})
...
public static final long LAST_MODIFIED = 1413806398961L
