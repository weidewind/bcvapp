...
class gsp_bcvappindex_default_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/index_default.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(5)
invokeTag('message','g',96,['code':("default.link.skip.label"),'default':("Skip to content&hellip;")],-1)
printHtmlPart(6)
invokeTag('meta','g',100,['name':("app.version")],-1)
printHtmlPart(7)
invokeTag('meta','g',101,['name':("app.grails.version")],-1)
printHtmlPart(8)
...
invokeTag('link','g',128,['controller':(c.logicalPropertyName)],3)
printHtmlPart(21)
}
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1416916980332L
